...
const Contact = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (name.length === 0 || email.length === 0 || message.length === 0) {
      ...
      emailjs
        .send(
          'service_42rzfnq', // service id
          'template_lb1lagl', // template id
          mailData,
          'BsxGhC83dtZI_r5l_' // public api
        )
        .then(
          (response) => {
            setError(false);
              ...
              <ul className="custom-list">
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">+1 408 218-5349</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                ...
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">luke-song</span>
                  </h6>
                </li>
              </ul>
              ...
              <div className="social">
                ...
                <ul className="list-inline social social-intro text-center p-none">
                  <li className="linkedin">
                    <a
                      title="LinkedIn"
                      href="https://www.linkedin.com/in/luke-song/"
                    >
                      <i className="fa fa-linkedin" />
                    </a>
                  </li>
                  <li className="twitter">
                    <a title="Twitter" href="https://twitter.com/lukesong_eth">
